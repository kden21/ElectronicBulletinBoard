...
public interface IUserReviewService
{
    ...
    public Task<UserReviewDto> GetUserReviewById(int userReviewId);
    ...
    /// <returns>Модель представления отзыва <see cref="UserReviewDto"/></returns>
    public Task<UserReviewDto> CreateUserReview(UserReviewDto userReviewDto);
    ...
    public Task<IEnumerable<UserReviewDto>> GetAllUserReviews(UserReviewFilterRequest? filterRequest);

    /// <summary>
    /// Удаляет отзыв.
    /// </summary>
    /// <param name="userReviewId">Идентификатор отзыва.</param>
    public Task DeleteUserReview(int userReviewId);
    ...
    public Task UpdateUserReview(int userReviewId, UserReviewDto userReviewDto);
}