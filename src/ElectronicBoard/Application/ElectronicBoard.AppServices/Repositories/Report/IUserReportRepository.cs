...
public interface IUserReportRepository
{
    ...
    public Task<IEnumerable<UserReportEntity>> GetAllUserReportEntities(UserReportFilterRequest? userReportFilter);
    ...
    public Task<UserReportEntity?> GetUserReportEntityById(int userReportId);
    ...
    public Task<int> AddUserReportEntity(UserReportEntity userReportModel);

    /// <summary>
    /// Обновляет данные жалобы.
    /// </summary>
    /// <param name="userReportModel">Жалоба <see cref="UserReportEntity"/>.</param>
    public Task UpdateUserReportEntity(UserReportEntity userReportModel);

    /// <summary>
    /// Удаляет жалобу.
    /// </summary>
    /// <param name="userReportId">Идентификатор жалобы <see cref="UserReportEntity"/>.</param>
    public Task DeleteUserReportEntity(int userReportId);
}